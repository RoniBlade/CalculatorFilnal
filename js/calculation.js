...
function calculationFormula7() {
  ...
  var sumCostCraft = Math.ceil(document.getElementById('smallFish').value*(128/100) + secondPoint + thirdPoint + 300*craftingCostBO) 
...
function calculationFormula10() {
  ...
  var sumCostCraft = Math.ceil(document.getElementById('ancientRelic').value*(94/100) + document.getElementById('rareRelic').value*(29/10) + document.getElementById('orehaRelic').value*(16/10) + 250*craftingCostBO) 
  var costWithCommision1Item = Math.floor(document.getElementById('largeArctusCrystal').value * 0.95)
  var costWithCommision1Craft = costWithCommision1Item*20*chancePerfectBO
  var craftsPerHour = (60/(60*reducedProductionBO))*3
  var profit = sumCostCraft*craftsPerHour
...
function reCalcSet() {
  ...
  chancePerfectBASup = (document.getElementById("chancePerfectA").value/100 + document.getElementById("chancePerfect").value/100 + 1)*5
  chancePerfectBA = 1 + (chancePerfectBASup/100)

  chancePerfectBOSup = (document.getElementById("chancePerfectO").value/100 + document.getElementById("chancePerfect").value/100 + 1)*5
  chancePerfectBO = 1 + (chancePerfectBOSup/100)

  craftingCostBA = 1 - (document.getElementById('craftingCost').value + document.getElementById('craftingCostA').value)/100
  craftingCostBO = 1 - (document.getElementById('craftingCost').value + document.getElementById('craftingCostO').value)/100

  reducedProductionBA = 1 - (document.getElementById("reducedProductionB").value + document.getElementById("reducedProductionA").value)/100
  reducedProductionBO = 1 - (document.getElementById("reducedProductionB").value + document.getElementById("reducedProductionO").value)/100
