...
var chancePerfectBASup = (document.getElementById("chancePerfectA").value/100 + document.getElementById("chancePerfect").value/100 + 1)*5
var chancePerfectBA = 1 + (chancePerfectBASup/100)

var chancePerfectBOSup = (document.getElementById("chancePerfectO").value/100 + document.getElementById("chancePerfect").value/100 + 1)*5
var chancePerfectBO = 1 + (chancePerfectBASup/100)

var craftingCostBA = 1 - (document.getElementById('craftingCost').value + document.getElementById('craftingCostA').value)/100
var craftingCostBO = 1 - (document.getElementById('craftingCost').value + document.getElementById('craftingCostO').value)/100


var reducedProductionBA = 1 - (document.getElementById("reducedProductionB").value + document.getElementById("reducedProductionA").value)/100
var reducedProductionBO = 1 - (document.getElementById("reducedProductionB").value + document.getElementById("reducedProductionO").value)/100


function calculationFormula1() {

    var sumCostCraft = document.getElementById('shyWildFlower').value*(18/100) + document.getElementById('wildFlower').value*(9/10) + 15*craftingCostBA 
    var costWithCommision1Item = document.getElementById('majorHPPotion').value * 0.95
...
function calculationFormula2() {
  ...
  var sumCostCraft = document.getElementById('shyWildFlower').value*(48/100) + document.getElementById('wildFlower').value*(24/10) + document.getElementById('brightWildFlower').value*(6/10) + 30*craftingCostBA 
  var costWithCommision1Item = document.getElementById('elementalHPPotion').value * 0.95
  var costWithCommision1Craft = costWithCommision1Item*3*chancePerfectBA
...
function calculationFormula3() {
  ...
  var sumCostCraft = document.getElementById('wildFlower').value*(8/10) + 30*craftingCostBA + (document.getElementById('shyWildFlower').value*(48/100) + document.getElementById('wildFlower').value*(24/10) + document.getElementById('brightWildFlower').value*(6/10) + 30*craftingCostBA) 
  var costWithCommision1Item = document.getElementById('splendidElementalHPPotion').value * 0.95
...
function calculationFormula4() {
  ...
  var sumCostCraft = document.getElementById('smallFish').value*(72/100) + secondPoint + thirdPoint + 203*craftingCostBO 
  var costWithCommision1Item = document.getElementById('smallArctusCrystal').value * 0.95
...
function calculationFormula5() {
  ...
  var sumCostCraft = document.getElementById('smallFish').value*(80/100) + secondPoint + thirdPoint + 205*craftingCostBO 
  var costWithCommision1Item = document.getElementById('arctusCrystal').value * 0.95
  var costWithCommision1Craft = costWithCommision1Item*30*chancePerfectBO
...
function calculationFormula6() {
  ...
  var sumCostCraft = document.getElementById('smallFish').value*(128/100) + secondPoint + thirdPoint + 250*craftingCostBO 
  var costWithCommision1Item = document.getElementById('largeArctusCrystal').value * 0.95
...
function calculationFormula7() {
  ...
  var sumCostCraft = document.getElementById('smallFish').value*(128/100) + secondPoint + thirdPoint + 300*craftingCostBO 
  var costWithCommision1Item = document.getElementById('hugeArctusCrystal').value * 0.95
...
function calculationFormula8() {
  ...
  var sumCostCraft = document.getElementById('ancientRelic').value*(56/100) + document.getElementById('rareRelic').value*(28/10) + document.getElementById('orehaRelic').value*(7/10) + 203*craftingCostBO 
  var costWithCommision1Item = document.getElementById('smallArctusCrystal').value * 0.95
  var costWithCommision1Craft = costWithCommision1Item*30*chancePerfectBO
  var craftsPerHour = (60/(30*reducedProductionBO))*3
  var profit = sumCostCraft*craftsPerHour
...
function calculationFormula9() {
  ...
  var sumCostCraft = document.getElementById('ancientRelic').value*(64/100) + document.getElementById('rareRelic').value*(26/10) + document.getElementById('orehaRelic').value*(8/10) + 205*craftingCostBO 
  var costWithCommision1Item = document.getElementById('arctusCrystal').value * 0.95
  var costWithCommision1Craft = costWithCommision1Item*30*chancePerfectBO
  var craftsPerHour = (60/(45*reducedProductionBO))*3
  var profit = sumCostCraft*craftsPerHour
...
function calculationFormula10() {
  ...
  var sumCostCraft = document.getElementById('ancientRelic').value*(94/100) + document.getElementById('rareRelic').value*(29/10) + document.getElementById('orehaRelic').value*(16/10) + 250*craftingCostBO 
  var costWithCommision1Item = document.getElementById('largeArctusCrystal').value * 0.95
  var costWithCommision1Craft = costWithCommision1Item*20*chancePerfectBO
  var craftsPerHour = (60/(60*reducedProductionBO))*3
  var profit = sumCostCraft*craftsPerHour
...
function calculationFormula11() {
  ...
  var sumCostCraft = document.getElementById('ancientRelic').value*(107/100) + document.getElementById('rareRelic').value*(51/10) + document.getElementById('orehaRelic').value*(52/10) + 300*craftingCostBO 
  var costWithCommision1Item = document.getElementById('hugeArctusCrystal').value * 0.95
  var costWithCommision1Craft = costWithCommision1Item*15*chancePerfectBO
  var craftsPerHour = (60/(60*reducedProductionBO))*3
  var profit = sumCostCraft*craftsPerHour
...
function calculationFormula12() {
  ...
  var sumCostCraft = document.getElementById('rawMeat').value*(72/100) + secondPoint + thirdPoint + 203*craftingCostBO 
  var costWithCommision1Item = document.getElementById('smallArctusCrystal').value * 0.95
  var costWithCommision1Craft = costWithCommision1Item*30*chancePerfectBO
  var craftsPerHour = (60/(60*reducedProductionBO))*3
  var profit = sumCostCraft*craftsPerHour
...
function calculationFormula13() {
  ...
  var sumCostCraft = document.getElementById('rawMeat').value*(80/100) + secondPoint + thirdPoint + 205*craftingCostBO 
  var costWithCommision1Item = document.getElementById('arctusCrystal').value * 0.95
  var costWithCommision1Craft = costWithCommision1Item*30*chancePerfectBO
  var craftsPerHour = (60/(45*reducedProductionBO))*3
  var profit = sumCostCraft*craftsPerHour
...
function calculationFormula14() {
  ...
  var sumCostCraft = document.getElementById('rawMeat').value*(128/100) + secondPoint + thirdPoint + 250*craftingCostBO 
  var costWithCommision1Item = document.getElementById('arctusCrystal').value * 0.95
  var costWithCommision1Craft = costWithCommision1Item*20*chancePerfectBO
  var craftsPerHour = (60/(60*reducedProductionBO))*3
  var profit = sumCostCraft*craftsPerHour
...
function calculationFormula15() {
  ...
  var sumCostCraft = document.getElementById('rawMeat').value*(142/100) + secondPoint + thirdPoint + 300*craftingCostBO 
  var costWithCommision1Item = document.getElementById('arctusCrystal').value * 0.95
  var costWithCommision1Craft = costWithCommision1Item*15*chancePerfectBO
  var craftsPerHour = (60/(60*reducedProductionBO))*3
  var profit = sumCostCraft*craftsPerHour
...
function calculationFormula16() {
  ...
  var sumCostCraft = document.getElementById('crudeMushroom').value*(32/100) + document.getElementById('freshMushroom').value*(16/10) + document.getElementById('exquisiteMushroom').value*(4/10) + document.getElementById('rareRelic').value*(5/10) + 15*craftingCostBA 
  var costWithCommision1Item = document.getElementById('panacea').value * 0.95
  var costWithCommision1Craft = costWithCommision1Item*3*chancePerfectBA
  var craftsPerHour = (60/(30*reducedProductionBA))*3
  var profit = sumCostCraft*craftsPerHour
...
function calculationFormula17() {
  ...
  var sumCostCraft = document.getElementById('exquisiteMushroom').value*(10/10) + 15*craftingCostBA + (document.getElementById('crudeMushroom').value*(32/100) + document.getElementById('freshMushroom').value*(16/10) + document.getElementById('exquisiteMushroom').value*(4/10) + document.getElementById('rareRelic').value*(5/10) + 15*craftingCostBA) 
  var costWithCommision1Item = document.getElementById('splendidPanacea').value * 0.95
  var costWithCommision1Craft = costWithCommision1Item*2*chancePerfectBA
...
function calculationFormula18() {
  ...
  var sumCostCraft = document.getElementById('shyWildFlower').value*(40/100) + document.getElementById('wildFlower').value*(20/10) + document.getElementById('brightWildFlower').value*(5/10) + document.getElementById('rareRelic').value*(2/10) + document.getElementById('sturdyTimber').value*(2/10) + 30*craftingCostBA
  var costWithCommision1Item = document.getElementById('timeStopPotion').value * 0.95
  var costWithCommision1Craft = costWithCommision1Item*3*chancePerfectBA
  var craftsPerHour = (60/(60*reducedProductionBA))*3
  var profit = sumCostCraft*craftsPerHour
...
function calculationFormula19() {
  ...
  var sumCostCraft = document.getElementById('crudeMushroom').value*(40/100) + document.getElementById('freshMushroom').value*(20/10) + document.getElementById('exquisiteMushroom').value*(5/10) + document.getElementById('rareRelic').value*(4/10) + document.getElementById('sturdyTimber').value*(2/10) + 30*craftingCostBA
  var costWithCommision1Item = document.getElementById('stimulant').value * 0.95
  var costWithCommision1Craft = costWithCommision1Item*3*chancePerfectBA
  var craftsPerHour = (60/(60*reducedProductionBA))*3
  var profit = sumCostCraft*craftsPerHour
...
function calculationFormula20() {
  ...
  var sumCostCraft = document.getElementById('shyWildFlower').value*(40/100) + document.getElementById('wildFlower').value*(20/10) + document.getElementById('brightWildFlower').value*(5/10) + document.getElementById('rareRelic').value*(2/10) + document.getElementById('strongIronOre').value*(2/10) + 30*craftingCostBA
  var costWithCommision1Item = document.getElementById('atropinePotion').value * 0.95
  var costWithCommision1Craft = costWithCommision1Item*3*chancePerfectBA
  var craftsPerHour = (60/(60*reducedProductionBA))*3
  var profit = sumCostCraft*craftsPerHour
...
function calculationFormula21() {
  ...
  var sumCostCraft = document.getElementById('crudeMushroom').value*(35/100) + document.getElementById('freshMushroom').value*(22/10) + document.getElementById('exquisiteMushroom').value*(5/10) + 16*craftingCostBO
  var costWithCommision1Item = document.getElementById('prayer').value * 0.95
  var costWithCommision1Craft = costWithCommision1Item*3*chancePerfectBA
  var craftsPerHour = (60/(60*reducedProductionBA))*3
  var profit = sumCostCraft*craftsPerHour
...
function calculationFormula22() {
  ...
  var sumCostCraft = document.getElementById('toughLeather').value*(17/100) + document.getElementById('wildFlower').value*(17/10) + document.getElementById('shyWildFlower').value*(27/100) + 16*craftingCostBO
  var costWithCommision1Item = document.getElementById('capeQuick').value * 0.95
  var costWithCommision1Craft = costWithCommision1Item*3*chancePerfectBA
  var craftsPerHour = (60/(60*reducedProductionBA))*3
  var profit = sumCostCraft*craftsPerHour
...
function calculationFormula23() {
  ...
  var sumCostCraft = document.getElementById('toughLeather').value*(22/100) + document.getElementById('shyWildFlower').value*(35/100) + document.getElementById('wildFlower').value*(22/10) + 16*craftingCostBO
  var costWithCommision1Item = document.getElementById('Al jadan Cape').value * 0.95
...
function calculationFormula24() { 
  ...
  var sumCostCraft = document.getElementById('toughLeather').value*(2/100) + document.getElementById('crudeMushroom').value*(35/100) + document.getElementById('freshMushroom').value*(15/10) + document.getElementById('exquisiteMushroom').value*(5/10) + document.getElementById('strongIronOre').value*(2/10) + 16*craftingCostBO
  var costWithCommision1Item = document.getElementById('ghostlyCapeSpeed').value * 0.95
  var costWithCommision1Craft = costWithCommision1Item*3*chancePerfectBO
  var craftsPerHour = (60/(60*reducedProductionBA))*3
  var profit = sumCostCraft*craftsPerHour
...
function calculationFormula25() { 
  ...
  var sumCostCraft = document.getElementById('heavyIronOre').value*(6/10) + document.getElementById('crudeMushroom').value*(32/100) + document.getElementById('freshMushroom').value*(12/10) + document.getElementById('exquisiteMushroom').value*(4/10) + 15*craftingCostBA
  var costWithCommision1Item = document.getElementById('pheromoneBomb').value * 0.95
  var costWithCommision1Craft = costWithCommision1Item*3*chancePerfectBO
  var craftsPerHour = (60/(30*reducedProductionBA))*3
  var profit = sumCostCraft*craftsPerHour
...
function calculationFormula26() { 
  ...
  var sumCostCraft = document.getElementById('heavyIronOre').value*(6/10) + document.getElementById('crudeMushroom').value*(32/100) + document.getElementById('freshMushroom').value*(12/10) + document.getElementById('exquisiteMushroom').value*(4/10) + 16*craftingCostBA
  var costWithCommision1Item = document.getElementById('pheromoneBomb').value * 0.95
  var costWithCommision1Craft = costWithCommision1Item*3*chancePerfectBO
  var craftsPerHour = (60/(30*reducedProductionBA))*3
  var profit = sumCostCraft*craftsPerHour
...
function calculationFormula27() { 
  ...
  var sumCostCraft = document.getElementById('exquisiteMushroom').value*(2/10) + (document.getElementById('heavyIronOre').value*(6/10) + document.getElementById('crudeMushroom').value*(32/100) + document.getElementById('freshMushroom').value*(12/10) + document.getElementById('exquisiteMushroom').value*(4/10) + 16*craftingCostBA) + 16*craftingCostBA
  var costWithCommision1Item = document.getElementById('hardDestructionBomb').value * 0.95
  var costWithCommision1Craft = costWithCommision1Item*3*chancePerfectBO
...
function calculationFormula28() { 
  ...
  var sumCostCraft = document.getElementById('ironOre').value*(10/100) + document.getElementById('crudeMushroom').value*(32/100) + document.getElementById('freshMushroom').value*(12/10) + document.getElementById('exquisiteMushroom').value*(4/10) + 15*craftingCostBA
  var costWithCommision1Item = document.getElementById('whirlwindGrenade').value * 0.95
  var costWithCommision1Craft = costWithCommision1Item*3*chancePerfectBO
  var craftsPerHour = (60/(30*reducedProductionBA))*3
  var profit = sumCostCraft*craftsPerHour
...
function calculationFormula29() { 
  ...
  var sumCostCraft = document.getElementById('ironOre').value*(3/100) + document.getElementById('crudeMushroom').value*(24/100) + document.getElementById('freshMushroom').value*(12/10) + document.getElementById('exquisiteMushroom').value*(3/10) + 15*craftingCostBA
  var costWithCommision1Item = document.getElementById('flashbangGrenade').value * 0.95
  var costWithCommision1Craft = costWithCommision1Item*3*chancePerfectBO
  var craftsPerHour = (60/(30*reducedProductionBA))*3
  var profit = sumCostCraft*craftsPerHour
...
function calculationFormula32() { 
  ...
  var sumCostCraft = document.getElementById('crudeMushroom').value*(24/100) + document.getElementById('freshMushroom').value*(12/10) + document.getElementById('exquisiteMushroom').value*(3/10) + document.getElementById('tenderTimber').value*(3/10) + 15*craftingCostBA
  var costWithCommision1Item = document.getElementById('highExplosiveGrenade').value * 0.95
  var costWithCommision1Craft = costWithCommision1Item*3*chancePerfectBO
  var craftsPerHour = (60/(30*reducedProductionBA))*3
  var profit = sumCostCraft*craftsPerHour
...
function calculationFormula33() { 
  ...
  var sumCostCraft = document.getElementById('crudeMushroom').value*(24/100) + document.getElementById('freshMushroom').value*(12/10) + document.getElementById('exquisiteMushroom').value*(3/10) + document.getElementById('tenderTimber').value*(3/10) + 15*craftingCostBA
  var costWithCommision1Item = document.getElementById('fragmentationGrenade').value * 0.95
  var costWithCommision1Craft = costWithCommision1Item*3*chancePerfectBO
  var craftsPerHour = (60/(30*reducedProductionBA))*3
  var profit = sumCostCraft*craftsPerHour
...
function calculationFormula35() { 
  ...
  var sumCostCraft = document.getElementById('crudeMushroom').value*(24/100) + document.getElementById('freshMushroom').value*(12/10) + document.getElementById('exquisiteMushroom').value*(3/10) + document.getElementById('ironOre').value*(5/100) + 15*craftingCostBA
  var costWithCommision1Item = document.getElementById('theSamumBomb').value * 0.95
  var costWithCommision1Craft = costWithCommision1Item*2*chancePerfectBO
  var craftsPerHour = (60/(30*reducedProductionBA))*3
  var profit = sumCostCraft*craftsPerHour
...
function calculationFormula36() { 
  ...
  var sumCostCraft = document.getElementById('crudeMushroom').value*(24/100) + document.getElementById('freshMushroom').value*(12/10) + document.getElementById('exquisiteMushroom').value*(3/10) + document.getElementById('ironOre').value*(5/100) + 15*craftingCostBA
  var costWithCommision1Item = document.getElementById('frostGrenade').value * 0.95
  var costWithCommision1Craft = costWithCommision1Item*2*chancePerfectBO
  var craftsPerHour = (60/(30*reducedProductionBA))*3
  var profit = sumCostCraft*craftsPerHour
...
function calculationFormula37() { 
  ...
  var sumCostCraft = document.getElementById('rawMeat').value*(96/100) + document.getElementById('treatedMeat').value*(48/10) + document.getElementById('smallFish').value*(80/100) + document.getElementById('redFish').value*(40/10) + secondPoint + thirdPoint + 50*craftingCostBA
  var costWithCommision1Item = document.getElementById('creamySelectedRabbit').value * 0.95
...
function calculationFormula38() { 
  ...
  var sumCostCraft = document.getElementById('rawMeat').value*(106/100) + document.getElementById('treatedMeat').value*(63/10) + document.getElementById('smallFish').value*(98/100) + document.getElementById('redFish').value*(52/10) + secondPoint + thirdPoint + 67*craftingCostBA
  var costWithCommision1Item = document.getElementById('stuffedWithApples').value * 0.95
  var costWithCommision1Craft = costWithCommision1Item*1*chancePerfectBO
  var craftsPerHour = (60/(60*reducedProductionBA))*3
  var profit = sumCostCraft*craftsPerHour
